...
import BitcoinSVG from "../../../assets/mockups/Bitcoin.svg";
      ...
      <div className="container">
        ...
        <div className="intro">
          <p>
            ...
            <span> simulating</span> basically anything you can do with a real
            crypto wallet
          </p>
        ...
        <div className="imgAndBlob">
          <img className="bitcoinSVG" src={BitcoinSVG} alt="homepage" />
